    ...
    <ul class="list-group">
      ...
      <li href="#" class="list-group-item text-left">
        ...
        <label class="pull-right">
          ...
          {{\Carbon\Carbon::parse($request['timeAdded'])->diffForHumans()}}
          <?php break?>
          @endforeach
            <a  class="btn btn-success btn-xs glyphicon glyphicon-ok"  href="{{ route('friends.accept',['id'=>session()->get('username'),'username'=>$fr->username])}}" title="View">Accept</a>
