...
<template x-if="tab === 'bar'">
    ...
    x-transition:enter-end="opacity-100 transform scale-100"
    >
        <button class="btn btn-primary" x-on:click="tab = 'foo'">Back</button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="#" class="user-link">{{$users->profile->nama_lengkap}}</a>
                        ...
                        <div class="media-body">
                            <div class="reviews-members-header">
                                ...
                                <h6 class="mb-1"><a class="text-black"
                                        href="#">{{UserHelp::get_fullname($review->profile_id)}}</a>
