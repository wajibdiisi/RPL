...
.jumbotron {
       ...
       <body id="body">
                ...
                <nav class="nav">
                    <div>
                        ...
                        <ul class="nav__list">
                            ...
                            <a href="{{route('report')}}" class="nav__link active">
            ...
            <div class="jumbotron jumbotron-fluid ">
                <div class="container">
                  <h1>Report</h1>
                  <p>Buatlah laporan dengan mencantumkan url untuk mempermudah 
                    admin dalam memperbaikinya
                    </p>
                  <hr>
                  <form>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Input your message"></textarea>
