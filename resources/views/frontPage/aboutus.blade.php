            ...
            <div class="l-navbar" id="navbar">
                <nav class="nav">
                    <div>
                        ...
                        <ul class="nav__list">
                          <a href="{{route('bantuan')}}"  class="nav__link">
                        ...
                        <a href="{{route('report')}}" class="nav__link">
                            ...
                            <a href="{{route('about_us')}}"  class="nav__link active">
            ...
            <div class="jumbotron jumbotron-fluid ">
                <div class="container">
                  ...
                  <div>
                    ...
                    <span class="nav__text">Muhamad Ilham Habib</span>
                    <span class="nav__text">| Front End</span>
                    </div>
                    <div>
                        <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png" alt="">
                    <span class="nav__text">Muhamad Iqbal Alif F</span>
                    <span class="nav__text">| Back End</span>
                    </div>
                    <div>
                        <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png" alt="">
                    <span class="nav__text">Nadhifal A F</span>
                    <span class="nav__text">| Front End</span>
                    </div>
                    <div>
                        <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png" alt="">
                    <span class="nav__text">Ahmad Irfan F</span>
                    <span class="nav__text">| Back End</span>
                    </div>
                    <div>
                        <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png" alt="">
                    <span class="nav__text">Gede Bagus D</span>
                    <span class="nav__text">| Front End</span>
                    </div>
                 </div>
                    <div>
